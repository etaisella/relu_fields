...
train_and_render() {
	...
	-i logs/rf/voxelArt_try_${1}_3dcnn_${10}_naive_${11}/saved_models/model_final.pth \
	-h logs/rf/${1}_${7}_sf${2}_iter${3}_lr${4}_stage${5}_samples${6}_shdeg${8}_clusters${9}/saved_models/model_final.pth \
	-o output_renders/${1}_${7}_sf${2}_iter${3}_lr${4}_stage${5}_samples${6}_shdeg${8}_voxelized_${10}/ \
	--voxelized=${12}
}
...
$train_num_samples_per_ray $gird_dim $sh_degree $clusters $new_grid_dim $naive_mode $voxelized